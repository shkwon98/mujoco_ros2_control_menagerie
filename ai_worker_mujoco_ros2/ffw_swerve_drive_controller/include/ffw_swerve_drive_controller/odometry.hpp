...
public:
    ...
    double getX() const
    {
        return position_x_odom_;
    }
    double getY() const
    {
        return position_y_odom_;
    }
    double getYaw() const
    {
        return orientation_yaw_odom_;
    }
    double getVx() const
    {
        return velocity_in_base_frame_linear_x_;
    }
    double getVy() const
    {
        return velocity_in_base_frame_linear_y_;
    }
    double getWz() const
    {
        return velocity_in_base_frame_angular_z_;
    }

    void setModuleParams(const std::vector<double> &module_x_offsets,
                         const std::vector<double> &module_y_offsets, const double wheel_radius);

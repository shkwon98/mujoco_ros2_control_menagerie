...
public:
    ...
    void init(rclcpp_lifecycle::LifecycleNode::WeakPtr node_interface,
    ...
    void publish_markers(const rclcpp::Time &stamp, double robot_vx, double robot_vy,
...
private:
    ...
    visualization_msgs::msg::Marker create_arrow_marker(
        ...
        const std_msgs::msg::ColorRGBA &color, double scale_x = ARROW_SHAFT_DIAMETER,
        double scale_y = ARROW_HEAD_DIAMETER, double scale_z = ARROW_HEAD_LENGTH);
    ...
    visualization_msgs::msg::Marker create_sphere_marker(int id, const rclcpp::Time &stamp,
                                                         const std::string &ns,
                                                         const geometry_msgs::msg::Point &position,
                                                         double radius,
                                                         const std_msgs::msg::ColorRGBA &color);

    visualization_msgs::msg::Marker create_text_marker(int id, const rclcpp::Time &stamp,
                                                       const std::string &ns,
    ...
    visualization_msgs::msg::Marker create_cube_marker(int id, const rclcpp::Time &stamp,
                                                       const std::string &ns,
                                                       const geometry_msgs::msg::Pose &pose,
                                                       const geometry_msgs::msg::Vector3 &scale,
                                                       const std_msgs::msg::ColorRGBA &color);

    void add_delete_marker_action(visualization_msgs::msg::MarkerArray &marker_array, int id,
                                  const std::string &ns);
    void add_delete_all_markers_in_ns_action(visualization_msgs::msg::MarkerArray &marker_array,
                                             const std::string &ns);

    std::optional<Point2D> get_line_intersection(Point2D p1, Point2D p2, Point2D p3, Point2D p4);
